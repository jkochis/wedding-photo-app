...
export type AppEventType = 'photos:loaded' | 'photos:filtered' | 'photo:uploaded' | 'photo:selected' | 'modal:opened' | 'modal:closed' | 'upload:started' | 'upload:progress' | 'upload:completed' | 'upload:error' | 'filter:changed' | 'people:selected' | 'error:occurred';
